...
<div x-show="sopHighlightOpen" 
    ...
    <!-- Backdrop -->
    <div class="fixed inset-0 bg-slate-900/70 backdrop-blur-sm" @click="ackSopHighlight()"></div>

    <!-- Modal Dialog -->
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col z-10 border border-amber-200"
...
Mohon konfirmasi opsi mana yang Bapak/Ibu pilih. Terima kasih atas pengertiannya.</div>
                    ...
                    <p class="text-[11px] text-gray-400 italic">
                        * Ubah teks di dalam tanda kurung siku [...] sesuai data spesifik pendaftaran pasien sebelum dikirimkan.
                    </p>
                </div>
