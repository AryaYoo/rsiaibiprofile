...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h2 class="text-2xl font-bold text-gray-800">Tambah Jadwal Layanan</h2>
        <p class="text-sm text-gray-500 mt-1">Tambahkan jadwal praktek dokter atau layanan baru</p>
    </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-3xl">
    <form action="{{ route('admin.schedules.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Jika dokter belum terdaftar, silakan tambahkan di menu <a href="{{ route('admin.doctors.create') }}" class="text-emerald-600 underline">Master Dokter</a>.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="day" id="day" value="{{ old('day') }}" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-shadow"
